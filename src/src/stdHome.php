...
if(isset($_POST["upload"])) {
    ...
    $sql = "INSERT INTO studentdetails (reg,name,degree,branch,image,doj,dob,blood,religion,community,parentname,income,parentaddr,parentphone,occupation,officialaddr,phonecomm,postal,mail,commadd,studphone,mailstud) VALUES ('$reg', '$name', '$degree', '$branch', '$imagename','$new_doj','$new_dob','$blood','$religion','$community','$parentname','$income','$parentaddress','$parentphone','$occupation','$officialaddress','$phonecomm','$postal','$parentemail','$commaddress','$studphone','$emailStud')";
